...
core:
	g++ -w -std=c++20 -ldl -o li_panel ../runner.cc -I../../HUI -L. -lHUI
	
plugins:
	LIST="background custom datetime example panel run"; \
	for f in $$LIST; do  g++ -w -std=c++20 -fPIC -shared -o Applet_$$f.so ../Applet_$$f.cc -I../../HUI -L. -lHUI  ; done
...
plugins-wlr:
	...
	g++ -w -std=c++20 -fPIC -shared  -o "Applet_windowlist.so" ../Applet_windowlist.cc -I. -I../../HUI -L. -lHUI `pkg-config --cflags --libs wayland-client`
