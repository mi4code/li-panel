...
core:
	g++ -w -std=c++20 -O2 -ldl -o li_panel ../runner.cc -I/usr/include/HUI -I../../HUI -L. -lHUI
	
plugins:
	LIST="background custom datetime example panel run"; \
	for f in $$LIST; do  g++ -w -std=c++20 -O2 -fPIC -shared -o Applet_$$f.so ../Applet_$$f.cc -I/usr/include/HUI -I../../HUI -L. -lHUI  ; done
...
plugins-wlr:
	...
	g++ -w -std=c++20 -O2 -fPIC -shared  -o "Applet_windowlist.so" ../Applet_windowlist.cc -I. -I/usr/include/HUI -I../../HUI -L. -lHUI `pkg-config --cflags --libs wayland-client`
